...
(5, 'Salmon', 22.5, 0.0, 19.0, 0.0),
(6, 'Broccoli', 2.8, 6.0, 0.4, 3.3);
...
(3, 5, (SELECT id FROM foobs.FoodUnit WHERE food_id = 5 AND name = 'Grams'), 200),
(3, 6, (SELECT id FROM foobs.FoodUnit WHERE food_id = 6 AND name = 'Grams'), 100);
